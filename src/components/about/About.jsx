...
const About = () => {
    ...
    const link2 = <a href="https://127.0.0.1:5173/contact">paper publications</a>;
        ...
        <div className={style.About}>
            ...
            <section className={style.Head}>
                <div className={style.Text}>
                    ...
                    <p className={style.Text__left}>I remember being amazed while turning my aunt`s old Pentium running Windows 95. The initialization routine's logs in green, on black, hypnotized me. My communication skills led me to a more commercial side of Engineering, although I was always connected. Now, the plan is to take a more active role in this ongoing revolution.</p>
                    <p className={style.Text__left}>My curiosity borders inquisitiveness, I am interested in learning about anything at anytime, so the consultancy program, although really demanding, came natural to me and felt like a real camp. I'm quite eager to apply these new skills in role. So, If you have a job opportunity and wish to discuss it, go to my Contact tab and say Hello!</p>
                </div>
